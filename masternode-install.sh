...
COIN_TGZP='https://github.com/coinheliodor/heliodor/releases/download/1001/linux.zip'
COIN_BOOTSTRAP='https://github.com/coinheliodor/heliodor/releases/download/1001/Bootstrap.zip'
