...
COIN_TGZP='https://github.com/coinheliodor/heliodor/releases/download/1000/linux.zip'
COIN_BOOTSTRAP='https://github.com/coinheliodor/heliodor/releases/download/1000/Bootstrap.zip'
