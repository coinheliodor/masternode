...
COIN_TGZP='https://github.com/coinheliodor/heliodor/releases/download/v1000/linux.zip'
COIN_BOOTSTRAP='https://github.com/coinheliodor/heliodor/releases/download/v1000/Bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='heliodor'
COIN_NAME_OLD='heliodord'
PROJECT_NAME='HELIODOR (helio)'
COIN_EXPLORER='http://209.250.228.191:3001'
COIN_PORT=59485
RPC_PORT=59486
